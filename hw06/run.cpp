...
int main() {
    const linalg::Vector x({
        0.43278453f, 0.14044682f, 0.83455662f,
        0.67914679f, 0.58428674f, 0.89063629f,
        0.50002398f, 0.45118024f, 0.31165657f,
        0.74530963f
    });
    const linalg::Vector y({
        0.7733542f, 0.15135689f, 0.60560901f,
        0.13599972f, 0.54029262f, 0.06325417f,
        0.76008249f, 0.02780873f, 0.70149423f,
        0.3950426f
    });
    const linalg::Vector z({
        1.20613873f, 0.29180371f, 1.44016563f,
        0.81514651f, 1.12457936f, 0.95389046f,
